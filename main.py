...
data_gen_args = dict(rotation_range=0.2,
                    ...
                    fill_mode='nearest')
myGene = trainGenerator(2,r'data\train','plastic','plastic',data_gen_args,save_to_dir = None)
# myGene = trainGenerator(2,r'data\membrane\train','image','label',data_gen_args,save_to_dir = None)
...
testGene = testGenerator(r"data\test", num_image=2)
